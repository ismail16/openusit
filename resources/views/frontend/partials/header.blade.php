...
<html lang="en">
  <head>
    ...
    <link rel="icon" type="img/icon" href="{{ asset('images/icon.png') }}">
    ...
    <link rel="stylesheet" href="{{ asset('frontend_assets/front/fronts/flaticon.css')}}">
    ...
    <noscript>
      <img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=383471665939429&ev=PageView&noscript=1"/>
    </noscript>
