        ...
        <div class="row abc">
            <div class="col-lg-3 col-sm-6 col-md-6 px-0">
                <a href="our-achievement">
                    <div class="achive-item text-center xtra2">
                        <img src="{{ asset('frontend_assets/images/achivement1_1.png')}}" alt="achivement" class="img-fluid">
            ...
            <div class="col-lg-3 col-sm-6 col-md-6 px-0">
                <a href="freelancing-success">
                    <div class="achive-item text-center">
                        <img src="{{ asset('frontend_assets/images/achivement2.png')}}" alt="achivement" class="img-fluid">
            ...
            <div class="col-lg-3 col-sm-6 col-md-6 px-0">
                <a href="job-placement">
                    <div class="achive-item text-center">
                        <img src="{{ asset('frontend_assets/images/achivement3.png')}}" alt="achivement" class="img-fluid">
            ...
            <div class="col-lg-3 col-sm-6 col-md-6 px-0">
                <a href="faculties">
                    <div class="achive-item br-0 text-center xtra3">
                        <img src="{{ asset('frontend_assets/images/achivement4.png')}}" alt="achivement" class="img-fluid">
        ...
        <div class="row">
            <div class="col-lg-12 pt-2">
                ...
                <div class="welcome-details">
                    <p>
                        Openus IT Institute,  IT training institutes in Bangladesh offers the best training opportunities.
                         It has been playing a vital role to eradicate the unemployment problem since 2020. 
                         Enriched with quality training this institute has never failed to help the individuals to reveal their talents 
                         making harmony between creativity and IT. No matter what is your background, we are offering 7 courses for you 
                         conducted by experienced trainers to advance your skills.
                    </p>
                    <p>
                        We are passionate about providing good service to our students. Thus, the students of this institute turn out to be successful marketers and establish their 
            ...
            <div class="row tabs">
                <div class="col-lg-4 col-sm-12 col-md-8 m-md-auto px-0">
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li class="active">
                            <a href="#tab_3" data-toggle="pill" class="active show">
                        ...
                        <li class="">
                            <a href="#tab_8" data-toggle="pill" class="">
                    ...
                    <div class="tab-content">
                            ...
                            <div class="row">
                                <div class="col-lg-7 col-sm-7 pr-0">
                                    <div class="gd-left">
                                        ...
                                        <a href="#"><span class="highlight-icon">» </span>Read More</a>
                                    </div>
                                    <div class="seat">
                                        <p> <img src="{{ asset('frontend_assets/images/seat.png')}}"> <span></span>Admission Going On </p>
                                    </div>
                                </div>
                                <div class="col-lg-5 col-sm-5">
                                    <div class="gd-right">
                                        <img src="{{ asset('frontend_assets/images/graphic.webp')}}" alt="gd1" class="img-fluid w-100">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="tab_2">
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-sm-5">
                                    <div class="gd-right">
                                        <img src="{{ asset('frontend_assets/images/web.webp')}}" alt="gd1" class="img-fluid w-100">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane active show" id="tab_3">
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-sm-5">
                                    <div class="gd-right">
                                        <img src="{{ asset('frontend_assets/images/development.webp')}}" alt="gd1" class="img-fluid w-100">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="tab_4">
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-sm-5">
                                    <div class="gd-right">
                                        <img src="{{ asset('frontend_assets/images/digital.webp')}}" alt="gd1" class="img-fluid w-100">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="tab_5">
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-sm-5">
                                    <div class="gd-right">
                                        <img src="{{ asset('frontend_assets/images/interior.png')}}" alt="gd1" class="img-fluid w-100">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="tab_6">
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-sm-5">
                                    <div class="gd-right">
                                        <img src="{{ asset('frontend_assets/images/ccna.webp')}}" alt="gd1" class="img-fluid w-100">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="tab_7">
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-sm-5">
                                    <div class="gd-right">
                                        <img src="{{ asset('frontend_assets/images/app.webp')}}" alt="gd1" class="img-fluid w-100">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="tab_8">
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-sm-5">
                                    <div class="gd-right">
                                        <img src="{{ asset('frontend_assets/images/uxui.webp')}}" alt="gd1" class="img-fluid w-100">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-7 col-sm-7 pr-0">
                                    <div class="gd-left">
                                        ...
                                        <p>You learn computer office Application 3 or 6 month programs and achieve a govt. approve certificate. You can be submit for any official job. I hope You get better chance.</p>
                                        <a href="#"><span class="highlight-icon">» </span>Read More</a>
                                    </div>
                                    <div class="seat">
                                        <p> <img src="{{ asset('frontend_assets/images/seat.png')}}"> <span></span>Admission Going On</p>
                                ...
                                <div class="col-lg-5 col-sm-5">
                                    <div class="gd-right">
                                        <img src="{{ asset('frontend_assets/images/basic-computer.png') }}" class="img-fluid w-100">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-7 col-md-7">
                <div class="counseling-img text-right">
                    <img src="{{ asset('frontend_assets/images/counselling.png')}}" alt="counselling" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row faci-main pl-2">
            <div class="col-lg-4 col-sm-6">
                <div class="facilities-item">
                    <img src="{{ asset('frontend_assets/images/24x7.png')}}" alt="24x7" class="img-fluid">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="facilities-item">
                    <img src="{{ asset('frontend_assets/images/faci1.png')}}" alt="faci1" class="img-fluid">
                    <h3>Lifetime Support</h3>
                    <p>
                        All students of Institute get supports for life. For any live project get our experts&#39; guideline and maintain it in international standard.
                    </p>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6">
                <div class="facilities-item">
                    <img src="{{ asset('frontend_assets/images/faci2.png')}}" alt="faci1" class="img-fluid">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="facilities-item">
                    <img src="{{ asset('frontend_assets/images/faci3.png')}}" alt="faci1" class="img-fluid">
                    <h3>Class Video</h3>
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="facilities-item">
                    <img src="{{ asset('frontend_assets/images/faci4.png')}}" alt="faci1" class="img-fluid">
                    <h3>Review Class</h3>
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="facilities-item">
                    <img src="{{ asset('frontend_assets/images/faci5.png')}}" alt="faci1" class="img-fluid">
                    <h3>Job Placement</h3>
                    <p>Acquire exclusive opportunities to work in international marketplaces as an expert freelancer. Openus IT creates opportunities by adding value to your career.</p>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-sm-6">
                <div class="other-achive-item">
                    <img src="{{ asset('frontend_assets/images/iso.png')}}" alt="iso" class="img-fluid">
                </div>
            </div>
            <div class="col-lg-6 col-sm-6">
                <div class="other-achive-item">
                    <img src="{{ asset('frontend_assets/images/mou.png')}}" alt="mou" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-9 col-sm-12 m-auto">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-5 col-sm-6 m-sm-auto">
                                <div class="leader-img">
                                    <img src="{{ asset('frontend_assets/images/default.jpg')}} " alt="Monir Hosen I CEO, Openus IT Institute" class="img-fluid w-100">
                                </div>
                            </div>
                            <div class="col-lg-8 col-md-7 col-sm-12">
                                <div class="leader-speach">
                                    <p>We are working with the vision of making the nation proficient in the Global IT village by building a platform which serves business owners as well as freelancers with comprehensive training for IT skills and professional enterprise solutions.
                                    </p>
                    ...
                    <div class="leader-slider-item">
                        <div class="row">
                            <div class="col-lg-4 col-sm-6 col-md-5 m-sm-auto">
                                <div class="leader-img">
                                    <img src="{{ asset('frontend_assets/images/default.jpg')}} " alt="Shompa Parvin I ED, Openus IT Institute" class="img-fluid w-100">
                                </div>
                            </div>
                ...
                <div class="left-leader-img">
                    <img src="{{ asset('frontend_assets/images/leader-left.png')}}" alt="leader-left">
                </div>
            </div>
        </div>
    </div>
                                            ...
                                            <div class="row partner-slider">
                                                <div class="col-lg-2 col-6 col-sm-4 col-md-3">
                                                    <div class="slider-item text-center">
                                                        <img src="{{ asset('frontend_assets/images/partner3.png')}}" alt="Republic of Bangladesh Logo" class="img-fluid">
                                                    </div>
                                                </div>
                                                <div class="col-lg-2 col-6 col-sm-4 col-md-3">
                                                    <div class="slider-item text-center">
                                                        <img src="{{ asset('frontend_assets/images/partner4.png')}}" alt="Bangladesh Technical Education Board Logo" class="img-fluid">
                                                    </div>
                                                </div>
                                                <div class="col-lg-2 col-6 col-sm-4 col-md-3">
                                                    <div class="slider-item text-center">
                                                        <img src="{{ asset('frontend_assets/images/partner5.png')}}" alt="Stamford University Bangladesh Logo" class="img-fluid">
                                                    </div>
                                                </div>
                                                <div class="col-lg-2 col-6 col-sm-4 col-md-3">
                                                    <div class="slider-item text-center">
                                                        <img src="{{ asset('frontend_assets/images/partner6.png')}}" alt="Bangladesh National Parliament Logo" class="img-fluid">
                                                    </div>
                                                </div>
                                                <div class="col-lg-2 col-6 col-sm-4 col-md-3">
                                                    <div class="slider-item text-center">
                                                        <img src="{{ asset('frontend_assets/images/partner7.png')}}" alt="Graphic Arts Institute Logo" class="img-fluid">
                                                    </div>
                                                </div>
                                                <div class="col-lg-2 col-6 col-sm-4 col-md-3">
                                                    <div class="slider-item text-center">
                                                        <img src="{{ asset('frontend_assets/images/partner8.png')}}" alt="ICT Division Logo" class="img-fluid">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="row partner-slider">
                                                <div class="col-lg-3 col-6 col-sm-6 col-md-4">
                                                    <div class="slider-item text-center">
                                                        <img src="{{ asset('frontend_assets/images/member1.png')}}" alt="BASIS Logo" class="img-fluid">
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-6 col-sm-6 col-md-4">
                                                    <div class="slider-item text-center">
                                                        <img src="{{ asset('frontend_assets/images/member2.png')}}" alt="BACCO" class="img-fluid">
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-6 col-sm-6 col-md-4">
                                                    <div class="slider-item text-center">
                                                        <img src="{{ asset('frontend_assets/images/member3.png')}}" alt="e-Cab Logo" class="img-fluid">
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-6 col-sm-6 col-md-4">
                                                    <div class="slider-item text-center">
                                                        <img src="{{ asset('frontend_assets/images/member4.png')}}" alt="Bangladesh Computer Samity Logo" class="img-fluid">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row concern-slide">
                                        <div class="col-lg-12">
                                            <div class="row partner-slider">
                                                <div class="col-lg-2 col-6 col-sm-4 col-md-3">
                                                    <div class="slider-item text-center">
                                                        <img src="{{ asset('frontend_assets/images/concern1.png')}}" alt="Openus IT Logo" class="img-fluid">
                                                    </div>
                                                </div>
                                                <div class="col-lg-2 col-6 col-sm-4 col-md-3">
                                                    <div class="slider-item text-center">
                                                        <img src="{{ asset('frontend_assets/images/concern3.png')}}" alt="Creative E School Logo" class="img-fluid">
                                                    </div>
                                                </div>
                                                <div class="col-lg-2 col-6 col-sm-4 col-md-3">
                                                    <div class="slider-item text-center">
                                                        <img src="{{ asset('frontend_assets/images/concern4.png')}}" alt="Priyo Lekha Logo" class="img-fluid">
                                                    </div>
                                                </div>
                                                <div class="col-lg-2 col-6 col-sm-4 col-md-3">
                                                    <div class="slider-item text-center">
                                                        <img src="{{ asset('frontend_assets/images/concern5.png')}}" alt="Occasiya Logo" class="img-fluid">
                                                    </div>
                                                </div>
                                                <div class="col-lg-2 col-6 col-sm-4 col-md-3">
                                                    <div class="slider-item text-center">
                                                        <img src="{{ asset('frontend_assets/images/concern6.png')}}" alt="Robo71 Logo" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
