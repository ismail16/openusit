...
@section('title', 'Not Certified Student')
...
<div class="box">
    <div class="box-header">
        ...
        <form action="{{route('admin.certificate')}}" method="post">
          ...
          <button type="submit" class="pull-left btn btn-sm bg-green"> <i class="fa fa-refresh" aria-hidden="false"></i> Certificate</button>
        </form>
        <form action="{{route('admin.payment')}}" method="post">
          ...
          <button type="submit" class="pull-left btn btn-sm bg-green"> <i class="fa fa-refresh" aria-hidden="false"></i> Payment</button>
        </form>
